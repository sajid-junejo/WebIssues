...
public class Comment extends javax.swing.JDialog {
    ...
    public void setDescription(String desc) {
        ...
        name.setText("<html>" + newText + "</html>");
        jTextPane1.setText("[quote Description]\n" + desc + "\n[/quote]\n\n");
    }
    ...
    private void initComponents() {
        ...
        name.setText("   Add Comment to the issue ");
        name.setMaximumSize(new java.awt.Dimension(110, 16));
        name.setMinimumSize(new java.awt.Dimension(110, 16));
        name.setPreferredSize(new java.awt.Dimension(110, 16));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        issueDao.addComment(HomeFrame.IssueID, modifiedText);
        dispose();
